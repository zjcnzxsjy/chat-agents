import { DEFAULT_BITRATE, DEFAULT_CHANNEL, DEFAULT_FORMAT, DEFAULT_LANGUAGE_BOOST, DEFAULT_PITCH, DEFAULT_SAMPLE_RATE, DEFAULT_SPEECH_MODEL, DEFAULT_SPEED, DEFAULT_VOICE_ID, DEFAULT_VOLUME } from "../const/index.js";
