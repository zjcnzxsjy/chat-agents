...
export function CollectionsCard({
  ...
  const handleDeleteCollection = async (id: string) => {
    ...
    if (selectedCollection?.id === id) {
      const newSelectedCollection = collections.find((c) => c.id !== id);
      ...
      const docs = await listDocuments(newSelectedCollection.id);
      setDocuments(docs);
    }
  };
      ...
      <CardContent>
        <CollectionsList
          ...
          onSelect={async (id) => {
            ...
            setSelectedCollection(collections.find((c) => c.id === id));
